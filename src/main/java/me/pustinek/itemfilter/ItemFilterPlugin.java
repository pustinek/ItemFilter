...
import me.pustinek.interactivemessenger.source.LanguageManager;
...
import me.pustinek.itemfilter.commands.CommandManager;
import me.pustinek.itemfilter.config.ConfigManager;
import me.pustinek.itemfilter.metrics.Metrics;
import me.pustinek.itemfilter.users.UserManager;
...
public final class ItemFilterPlugin extends JavaPlugin {
    ...
    private void initLanguage( ) {
        new LanguageManager(
                ...
                getConfig().getString("language", "Default"),     // The language to use indicated by the plugin user
                "Default",                                  // The default language, expected to be shipped with the plugin and should be complete, fills in gaps in the user-selected language
